...
#ifdef F2FS_BLOCK_LEVEL_HC_SEPARATION
	int i_hc_type;
	struct f2fs_hc_file_info* i_hc_file;
	block_t i_hc_addr; 		/* Pointer to f2fs_hc_file */
#endif
};
...
#ifdef F2FS_BLOCK_LEVEL_HC_SEPARATION
struct f2fs_hc_file_info {
        __le64 nblocks;         	/* # of blocks included in this file */
	__le64 nwritten;		/* # of write request */ 
	struct mutex hc_file_mutex;	/* hc file lock */
};

struct f2fs_hc_group_info {
        __le64 nblocks;         	/* # of blocks included in this group */
        __le64 total_hotness;   	/* the summation of the hotness of the member blocks */
	struct mutex hc_group_mutex;	/* hc group lock */
};
#endif
...
#ifdef F2FS_BLOCK_LEVEL_HC_SEPARATION
	struct f2fs_hc_group_info hc_group_info[NR_HOTNESS_GROUP];
#endif
};
...
#ifdef F2FS_BLOCK_LEVEL_HC_SEPARATION
static inline struct f2fs_hc_file_info *F2FS_HC_FILE_I(struct page *page)
{
	return (struct f2fs_hc_file_info *)page_address(page);
}
#endif
