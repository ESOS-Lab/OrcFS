...
#	PreOccupySize_1K=`echo $TotalSize_1K*70/100 | bc`
	ToWriteSize_1K=`echo $TotalSize_1K*85/100 | bc`
	FileSize_1K=131072
...
#	./program  path  file_size_1k  record_size_1k  random_ratio(%)  test_mode
	./comp_gc_test2	$MNT $ToWriteSize_1K 4 50 0
...
#		./program  path  file_size_1k  record_size_1k  random_ratio(%)  test_mode
		./comp_gc_test2 $MNT $ToWriteSize_1K 4 50 1 >> ${STATDIR}/iops
