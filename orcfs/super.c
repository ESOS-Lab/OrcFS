...
try_onemore:
	...
	build_gc_manager(sbi);
        ...
        block_copy_secno = (unsigned int*)kmalloc(sizeof(unsigned int)*max_block_copy_index, GFP_KERNEL);
        block_copy_type = (unsigned int*)kmalloc(sizeof(unsigned int)*max_block_copy_index, GFP_KERNEL);
        block_copy_node = (unsigned int*)kmalloc(sizeof(unsigned int)*max_block_copy_index, GFP_KERNEL);
        gc_sec_latency = (long long*)kmalloc(sizeof(long long)*max_block_copy_index, GFP_KERNEL);
        gc_total_latency = (long long*)kmalloc(sizeof(long long)*max_block_copy_index, GFP_KERNEL);
